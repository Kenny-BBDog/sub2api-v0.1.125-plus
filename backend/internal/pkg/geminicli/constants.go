...
const (
	...
	// GeminiCLIOAuthClientID/Secret are intentionally not embedded in public source.
	// Set them through env when using the built-in Gemini CLI OAuth flow.
	GeminiCLIOAuthClientID     = "example-gemini-cli-oauth-client-id"
	GeminiCLIOAuthClientSecret = "example-gemini-cli-oauth-client-secret"

	// GeminiCLIOAuthClientIDEnv/GeminiCLIOAuthClientSecretEnv configure the built-in client.
