...
const (
	...
	// Antigravity OAuth credentials are intentionally not embedded in public source.
...
// ClientID/defaultClientSecret 可通过环境变量配置。
// The defaults are inert placeholders so public source does not embed OAuth secrets.
var ClientID = "example-antigravity-oauth-client-id"
var defaultClientSecret = "example-antigravity-oauth-client-secret"
